        ...
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-brand to-red-700 p-4">
          ...
          <div className="relative">
            ...
            <p className="text-[10px] text-white/70 font-jakarta leading-relaxed mb-3">
              Unlimited jobs, newsletter & social promotion.
            </p>
            <Link href="/employer/promote" className="block w-full text-center bg-white text-brand text-[11px] font-bold font-jakarta py-2 rounded-lg hover:bg-white/90 transition-colors">
              Upgrade to Pro
            </Link>
          </div>
        </div>
