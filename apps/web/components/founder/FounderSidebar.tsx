  ...
  return (
    <aside className="w-[240px] h-screen bg-white dark:bg-gray-950 border-r border-gray-100 dark:border-gray-800 flex flex-col shrink-0">
      ...
      <div className="h-14 flex items-center px-4 border-b border-gray-100 dark:border-gray-800">
        <Link href="/founder/dashboard" className="flex items-center gap-2.5">
          <img src="/logo-light.svg" alt="AI Startup Impact" className="h-16 w-auto dark:hidden" />
          <img src="/logo-dark.svg" alt="AI Startup Impact" className="h-16 w-auto hidden dark:block" />
        ...
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-brand to-red-700 p-4">
          ...
          <div className="relative">
            ...
            <p className="text-[10px] text-white/70 font-jakarta leading-relaxed mb-3">
              Boost visibility, featured listing & priority support.
            </p>
            <Link href="/founder/settings" className="block w-full text-center bg-white text-brand text-[11px] font-bold font-jakarta py-2 rounded-lg hover:bg-white/90 transition-colors">
              Upgrade to Pro
            </Link>
          </div>
        </div>
