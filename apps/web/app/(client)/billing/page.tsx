      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 p-6">
          ...
          <div className="space-y-4">
            <div>
              <p className="text-xs text-gray-400 font-jakarta uppercase mb-1">Total Spent</p>
              <p className="font-sora font-extrabold text-2xl text-brand">₹{totalSpent.toLocaleString('en-IN')}</p>
            </div>
            <div>
              <p className="text-xs text-gray-400 font-jakarta uppercase mb-1">Payment Method</p>
              <div className="flex items-center gap-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg p-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 font-jakarta">Visa · Expires 12/26</p>
                </div>
              </div>
            </div>
