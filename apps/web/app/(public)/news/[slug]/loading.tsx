    ...
    <div className="max-w-7xl mx-auto px-0 sm:px-2 lg:px-4 py-6 sm:py-10 animate-pulse">
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
        ...
        <article className="flex-1 min-w-0 max-w-3xl mx-auto lg:mx-0 w-full">
          {/* Category badge */}
          <div className="h-5 w-16 bg-gray-200 dark:bg-gray-800 rounded-full mb-4" />

          {/* Title */}
          <div className="space-y-2 mb-4">
            <div className="h-7 sm:h-9 w-full bg-gray-200 dark:bg-gray-800 rounded-lg" />
            <div className="h-7 sm:h-9 w-3/4 bg-gray-200 dark:bg-gray-800 rounded-lg" />
          </div>

          {/* Excerpt */}
          <div className="h-4 w-full bg-gray-200 dark:bg-gray-800 rounded mb-1" />
          <div className="h-4 w-5/6 bg-gray-200 dark:bg-gray-800 rounded mb-6" />
          ...
          <div className="mt-10 sm:mt-12">
            <div className="h-6 w-36 bg-gray-200 dark:bg-gray-800 rounded mb-6" />
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4">
                  <div className="h-4 w-14 bg-gray-200 dark:bg-gray-800 rounded-full mb-2" />
                  <div className="h-4 w-full bg-gray-200 dark:bg-gray-800 rounded mb-1" />
