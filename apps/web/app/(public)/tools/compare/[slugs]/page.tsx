        ...
        <div className="grid grid-cols-3">
          ...
          <div className="p-4 border-b border-r border-gray-100 dark:border-gray-800 text-center">
            <div className="flex flex-col items-center gap-2">
              {t1.logoUrl && <Image src={t1.logoUrl} alt="" width={40} height={40} sizes="40px" className="w-10 h-10 rounded-lg object-contain border border-gray-100 dark:border-gray-700 p-1" />}
          ...
          <div className="p-4 border-b border-gray-100 dark:border-gray-800 text-center">
            <div className="flex flex-col items-center gap-2">
              {t2.logoUrl && <Image src={t2.logoUrl} alt="" width={40} height={40} sizes="40px" className="w-10 h-10 rounded-lg object-contain border border-gray-100 dark:border-gray-700 p-1" />}
