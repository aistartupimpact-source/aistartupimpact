...
DROP TABLE IF EXISTS "GovernmentScheme" CASCADE;
DROP TABLE IF EXISTS "PolicyUpdate" CASCADE;
DROP TABLE IF EXISTS "AIResearcher" CASCADE;
DROP TABLE IF EXISTS "IndianAITool" CASCADE;
DROP TABLE IF EXISTS "FeaturedFounder" CASCADE;
